...
- Permissions are assigned based on role configuraton.
...
- Recipient loses the ability to join using that instance of the invitation.
- Marked as revoked and becomes inactive.
