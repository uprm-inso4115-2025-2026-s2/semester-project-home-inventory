...
If under the collections the user doesn't find the item they are looking for, they can add a new item to the collection by clicking the + button. This will open this page were the user would see a preview of the item they are adding and a form to add the item to the custom collection.
