...
**AI Disclosure:** Portions of the research and example code snippets were written with the assistance of Artificial Intelligence tools. The flow diagram of the feature architecture, required and optional fields for manual entry, error handling, and other elements were verified by the human author, @devlin-hahn04.
