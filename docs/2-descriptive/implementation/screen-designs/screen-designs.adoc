...
=== Wireframes / mockups
* Alerts & Notifications Screen: image:2-descriptive/implementation/screen-designs/Alerts-&-Notifications-Screen/images/alerts-wireframes.png[]
* Budget Spending Page: image:2-descriptive/implementation/screen-designs/Budget-Spending-Screen/images/Budges_spending_wireframe.png[]
* Error or Empty File Icon: image:2-descriptive/implementation/screen-designs/Error-or-Empty-File-Icon/images/Error or Empty File Icon Wireframe.png[]
* Duplicate Warnings Icon: image:2-descriptive/implementation/screen-designs/Duplicate-Warnings-Icon/images/Duplicate Warnings Wireframe.png[]
