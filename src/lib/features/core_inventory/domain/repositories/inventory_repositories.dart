...
abstract class InventoryRepository {
  ...
  // Support fetching by owner identifier (e.g., supabase uuid string)
  Future<InventoryEntity> getInventoryByOwnerIdentifier(String ownerIdentifier);
