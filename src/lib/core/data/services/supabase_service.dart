...
class SupabaseService {
  ...
  Stream<PostgrestList> streamLike(String table, String column, String value) {
    return _supabase
        .from(table)
        .stream(primaryKey: ['id'])
        .map(
  ...
  Future<PostgrestList> update(String table, Map<String, dynamic> data) async {
  ...
  Future<PostgrestList> delete(String table, Map<String, dynamic> data) async {
