...
- ✅ Items display correctly in designated categories/rooms
- ✅ Updates and deletions are accurately reflected
- ✅ Notifications trigger at correct thresholds
- ✅ Filters return accurate results quickly
- ✅ Spending calculations match actual expenses
- ✅ Shared inventory syncs correctly between users
- ✅ Reports accurately reflect inventory data
...
2. **Follow the workflow:**
   - Create issue → Create branch → Work → Commit → PR → Review
